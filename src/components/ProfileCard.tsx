...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(240, 240, 240, 0.8) 0%, rgba(255, 255, 255, 0.8) 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      // Minimal theme: remove sunpillar colors
      '--sunpillar-clr-1': 'transparent',
      '--sunpillar-clr-2': 'transparent',
      '--sunpillar-clr-3': 'transparent',
      '--sunpillar-clr-4': 'transparent',
      '--sunpillar-clr-5': 'transparent',
      '--sunpillar-clr-6': 'transparent'
    }),
  ...
  const shineStyle = {
    maskImage: 'var(--icon)',
    maskMode: 'luminance',
    maskRepeat: 'no-repeat', // Changed to no-repeat for a more subtle effect
    maskSize: '100%', // Adjusted size
    maskPosition: 'center', // Centered
    filter: 'brightness(1) contrast(1) saturate(1) opacity(0.1)', // Much subtler filter
    animation: 'none', // Removed animation
    mixBlendMode: 'overlay' as const, // Changed blend mode
  ...
  const glareStyle: React.CSSProperties = {
    ...
    backgroundImage: `radial-gradient(
      farthest-corner circle at var(--pointer-x) var(--pointer-y),
      rgba(255, 255, 255, 0.3) 0%, /* Softer white glare */
      transparent 70% /* Fade out faster */
    )`,
    mixBlendMode: 'soft-light', // Changed blend mode for subtlety
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            ...
            maxHeight: '540px',
            aspectRatio: '0.718',
            borderRadius: cardRadius, // Keep card radius
            backgroundBlendMode: 'normal', // Changed blend mode to normal
              ...
              {showUserInfo && (
                <div
                  ...
                  style={{
                      ...
                      borderColor: 'rgba(0, 0, 0, 0.1)', // Darker border
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col items-start gap-1.5">
                      <div className="text-sm font-medium text-gray-900 leading-none">@{handle}</div> {/* Darker text */}
                      <div className="text-sm text-gray-600 leading-none">{status}</div> {/* Darker text */}
                    </div>
                  </div>
                  <button
                    className="border border-gray-200 rounded-lg px-4 py-3 text-xs font-semibold text-gray-800 cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-gray-400 hover:-translate-y-px" // Darker border and text
            ...
            >
              <div className="w-full absolute flex flex-col" style={{ top: '3em', display: 'flex', gridArea: 'auto' }}>
                <h3
                  ...
                  style={{
                    fontSize: 'min(5svh, 3em)', // Keep font size
                    backgroundImage: 'none', // Removed gradient
                    color: '#1f2937', // Solid dark gray color
                ...
                <p
                  ...
                  style={{
                    ...
                    top: '-12px',
                    fontSize: '16px',
                    margin: '0 auto', // Keep margin
                    backgroundImage: 'none', // Removed gradient
                    color: '#4b5563', // Solid medium gray color
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text',
                    display: 'block',
